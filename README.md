...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/chart-studio-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/chart-studio-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add chart-studio
# for installing globally
pixi global install chart-studio
```
...
It is possible to list all of the versions of `chart-studio` available on your platform:
...
```
pixi search chart-studio --channel conda-forge
```
